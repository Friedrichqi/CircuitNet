...
def train():
    ...
    pretrained_path = f'work_dir/congestion_gpdl_qint{arg_dict["quant_bit"]}/model_iters_400000.pth'
    if not os.path.exists(pretrained_path):
        import glob
        pretrained_path = f'work_dir/congestion_gpdl_qint{arg_dict["quant_bit"]}/'
    ...
    print(f"Loading pretrained model from {arg_dict['pretrained']}")
