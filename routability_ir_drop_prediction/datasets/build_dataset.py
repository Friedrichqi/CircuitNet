...
def build_dataset(opt):
    ...
    if opt['test_mode']:
        ...
        return IterLoader(DataLoader(dataset=dataset, num_workers=16, batch_size=opt['batch_size'], shuffle=True, drop_last=True, pin_memory=True, persistent_workers=True))
